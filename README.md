...
Specifically, the current implementation of CHISEL has been designed to be diretly applied to low-coverage DNA sequencing data from 10X Genomics CNV solution, however CHISEL will be adapted to the data generated by any other available technology.
